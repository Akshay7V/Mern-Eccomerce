    ...
    return (
        <div className='h-16 bg-gray-300 px-3 py-1 items-center flex'>
            <div className="w-1/2 flex">
                <Link to={'/'} className='flex gap-2 items-center text-2xl font-semibold mr-auto my-auto'>
                    ...
                    Eccommerce</Link>
                <div className="flex bg-white px-2 rounded-md">
                    <input className='w-80 p-2 rounded-sm border-none outline-none' type="text" placeholder='Search Any Products' />
